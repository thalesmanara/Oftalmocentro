...
const allowedCompKeys = ['n8n','database','storage','tika','ocr','tabular','embeddings','configuration','sessions','audit','documents','backup','aiEval','aiPrompts','qdrant','retrieval'];
const components = {};
